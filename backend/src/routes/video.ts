...
const VIDEO_SOURCES = [
    { id: 'ffzy', name: 'Recursos extraordinários', url: 'http://cj.ffzyapi.com/api.php/provide/vod/' },
    { id: 'hnzy', name: 'Recursos da Red Bull', url: 'https://hongniuzy2.com/api.php/provide/vod/' },
    { id: 'wjzy', name: 'Recursos infinitos', url: 'https://api.wujinapi.com/api.php/provide/vod/' },
    { id: 'jszy', name: 'Recursos extremamente rápidos', url: 'https://jszyapi.com/api.php/provide/vod/' },
    { id: 'uku', name: 'Urecursos legais', url: 'https://api.ukuapi.com/api.php/provide/vod/' },
    { id: 'bdzy', name: 'Recursos do Baidu', url: 'https://api.apibdzy.com/api.php/provide/vod/' },
    { id: 'ikun', name: 'iKunrecurso', url: 'https://ikunzyapi.com/api.php/provide/vod/' },
    { id: 'zuid', name: 'Recursos máximos', url: 'https://api.zuidapi.com/api.php/provide/vod/' }
];
...
router.get('/latest', async (req, res) => {
    ...
    // We'll pick a single reliable fast source (like extraordinário or Velocidade extrema) to get a quick feed, 
    // or round-robin them. Let's just use the first source (extraordinário) for the main feed to avoid duplicate/messy home feeds.
