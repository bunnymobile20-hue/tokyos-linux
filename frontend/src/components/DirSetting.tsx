...
export default function DirSetting({ label, value, onChange, placeholder, description, saveLabel = 'salvar' }: DirSettingProps) {
            ...
            >
              ...
              >
                ...
                <input 
                  ...
                  placeholder={placeholder || 'Deixe em branco para usar o diretório padrão...'}
